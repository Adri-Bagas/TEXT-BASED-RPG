...
//PICK1
Route::post('picked1', [ScenarioController::class, 'picked1']);
Route::post('picked2', [ScenarioController::class, 'picked2']);
Route::post('picked3', [ScenarioController::class, 'picked3']);
Route::post('picked4', [ScenarioController::class, 'picked4']);

Route::post('chara/status', [UserCharacterController::class, 'checkStatus']);

Route::post('chara/reset/death/lol', [UserCharacterController::class, 'resetChara']);

Route::post('unEquip/Item', [CharaEquipmentController::class, 'unEquip']);
Route::post('evenTheBackButtonIsAnAjaxRequest', [CharaEquipmentController::class, 'backButton']);